...
class TicketControlView(discord.ui.View):
    ...
    async def claim(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            if not interaction.user.guild_permissions.manage_messages:
                 return await interaction.followup.send("❌ You are not authroized.", ephemeral=True)
            ...
            async with AsyncSessionLocal() as db:
                ...
                if ticket.claimed_by:
                    return await interaction.followup.send(f"Ticket already claimed by <@{ticket.claimed_by}>", ephemeral=True) 
            ...
            logger.error(f"Error in claim ticket: {e}")
            await interaction.followup.send(f"❌ Error claiming ticket: {e}", ephemeral=True)
    ...
    async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            logger.error(f"Error in close ticket: {e}")
...
class TicketCreateSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            traceback.print_exc()
            await interaction.followup.send(f"❌ Failed to create ticket. Error: {e}\nCheck bot permissions!", ephemeral=True)
...
class Tickets(commands.Cog):
    ...
    async def setup_tickets(self, interaction: discord.Interaction, channel: discord.TextChannel = None):
        ...
        try:
            ...
            await interaction.followup.send(f"❌ Error setting up tickets: {e}", ephemeral=True)
            logger.error(f"Setup tickets error: {e}")
    ...
    async def set_role(self, interaction: discord.Interaction, role: discord.Role):
        ...
        try:
            ...
            await interaction.followup.send(f"✅ Tickets will now be visible to {role.mention}", ephemeral=True)
        except Exception as e:
    ...
    async def add_category(self, interaction: discord.Interaction, label: str, value: str, emoji: str, description: str = None):
        ...
        try: 
            ...
            await interaction.followup.send(f"✅ Added category: **{label}**", ephemeral=True)
        except Exception as e:
            await interaction.followup.send(f"❌ Error: {e}", ephemeral=True)
