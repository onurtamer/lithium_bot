...
def upgrade() -> None:
    ...
    sa.Column('permission_role', sa.BigInteger(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    # Guilds: Use BigInteger ID as PK (Snowflake)
    ...
    # op.create_index(op.f('ix_guilds_discord_id'), 'guilds', ['discord_id'], unique=True) # Removed as ID is PK
    ...
    sa.Column('no_xp_channels', sa.String(), nullable=False), # Valid: JSON/String of IDs? Keeping String for list storage if simplified
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    # Users: Use BigInteger ID as PK (Snowflake)
    ...
    # op.create_index(op.f('ix_users_discord_id'), 'users', ['discord_id'], unique=True) # Removed
